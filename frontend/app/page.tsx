  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-0 lg:grid-cols-12">
            <div className="p-6 lg:col-span-7 lg:p-10">
              ...
              <h2 className="mt-5 max-w-2xl text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">
                Clinical medication safety, designed for Indian workflows.
              </h2>

              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
                Verify interactions, surface evidence, and generate clinician-ready
                communication drafts before a medication reaches the patient.
              </p>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {[
                  { label: "Evidence-backed", value: "10 rules" },
                  { label: "Explainable", value: "Traceable" },
                  { label: "Human-reviewed", value: "Clinician control" },
                ].map((item) => (
                  <div
                    key={item.label}
            ...
            <div className="border-t border-slate-200 bg-linear-to-br from-slate-950 to-slate-800 p-6 text-white lg:col-span-5 lg:border-t-0 lg:border-l lg:p-8">
              ...
              <div className="mt-5 grid gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Generate clinician, patient, and follow-up drafts from the report.",
                  },
                  {
                    title: "India-ready Workflow",
                    text: "Built for busy pharmacies, clinics, and polypharmacy scenarios.",
                  },
                ].map((feature) => (
                  <div
                    key={feature.title}
        ...
        {/* Main content */}
        <section id="analysis" className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Quick demo cases help you present a reliable live workflow in seconds.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {demoCases.map((demo) => (
                    <button
                      key={demo.subtitle}
                      type="button"
                      onClick={() => loadDemoCase(demo.current, demo.newMed)}
                      className={`rounded-2xl border px-4 py-3 text-left transition ${toneStyles[demo.tone]}`}
                    >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  A fast clinical workflow that starts with medication entry and ends
                  with a human-reviewed recommendation.
                </p>
              </div>
              <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Deterministic rules first, evidence trace always, and communication
              ...
              {state === "idle" && (
                <div className="flex min-h-112 flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 max-w-sm text-sm leading-6 text-slate-500">
                    Enter medications or use a demo case to generate a clinical safety
                    assessment with evidence and communication drafts.
                  </p>
                </div>
              )}
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-5 text-center text-xs text-slate-400 sm:px-6 lg:px-8">
          ClinixSafe · Build in AI for India · Prototype · Not for clinical use
        </div>
      </footer>
    </div>
  );
